...
fixture.withDomParser(function () {
  withRequest(fixture.read('extras/parent.xml'), function (requests, respond) {
    ...
    assert.deepStrictEqual(detail.cast.slice(0, 2).map(function (person) {
      ...
      ['Natsuki Hanae', 'Tanjiro Kamado (voice)', 'https://plex.example.test/1/people/1389be21fb6aa62e8cd0bef6f3bc460d.jpg'],
      ['Takahiro Sakurai', 'Giyu Tomioka (voice)', 'https://plex.example.test/0/people/0375562f7451679cbedf13fcf98b999f.jpg']
...
fixture.withDomParser(function () {
  withRequest(fixture.read('extras/extras.xml'), function (requests, respond) {
    ...
    assert.deepStrictEqual(extras.map(function (item) {
      ...
      ['fixture-rating-009', 'Demon Slayer-Kimetsu No Yaiba Infinity Castle (Italian Teaser Trailer)', 'trailer', 133000],
      ['fixture-rating-011', 'Demon Slayer-Kimetsu No Yaiba-Infinity Castle (Italian Date Reveal Teaser Trailer)', 'trailer', 30000]
