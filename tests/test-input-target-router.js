...
assert.strictEqual(InputTargetRouter.resolve({ playbackCompatibilityOpen: true, appView: 'settings' }), 'playback-compatibility', 'compatibility memory takes precedence over settings');
