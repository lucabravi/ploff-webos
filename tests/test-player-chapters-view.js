...
function element(tag, className, text) {
  ...
  result.getBoundingClientRect = function () { return { width: 300.9, height: 132.8 }; };
...
var view = PlayerChaptersView.create({
  ...
  ProgressiveImages: {
    previewSize: function () { return { width: 96, height: 42 }; },
    renderedSize: function (image) { var rect = image.getBoundingClientRect(); return { width: Math.floor(rect.width), height: Math.floor(rect.height) }; }
  },
