  ...
  function create(options) {
    ...
    function playbackSnapshot() {
      ...
      return {
        ...
        offsetBase: diagnostics.offsetBase,
        nativeCurrentTime: diagnostics.nativeCurrentTime,
        nativeAbsoluteTime: diagnostics.nativeAbsoluteTime,
        bufferStartNative: diagnostics.bufferStartNative,
        bufferStartPublic: diagnostics.bufferStartPublic,
        bufferStartOffsetBase: diagnostics.bufferStartOffsetBase,
        bufferRecoveryAccepted: diagnostics.bufferRecoveryAccepted,
        bufferRecoveryReason: diagnostics.bufferRecoveryReason,
        bufferRecoveryInitialReason: diagnostics.bufferRecoveryInitialReason,
        bufferRecoveryDelta: diagnostics.bufferRecoveryDelta,
        bufferRecoveryTarget: diagnostics.bufferRecoveryTarget,
        bufferRecoveryCandidate: diagnostics.bufferRecoveryCandidate,
